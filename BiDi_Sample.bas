...
' ========================================================================================
' SeleniumVBA BiDi Simultaneous Connection Stress Test (Corrected URL Edition)
' Aim: Test the limits of VBA's socket management capabilities using a valid target page.
' ========================================================================================
Public Sub Main08()
    ' --- Settings: Starting with 5 windows ---
    Const NUM_WINDOWS As Integer = 5
...
EmergencyShutdown:
    ...
    For w = 1 To NUM_WINDOWS
        ...
        If Not bidi(w) Is Nothing Then bidi(w).Shutdown
        If Not driver(w) Is Nothing Then driver(w).Shutdown
        Set bidi(w) = Nothing: Set driver(w) = Nothing
        DoEvents
    Next
End Sub
