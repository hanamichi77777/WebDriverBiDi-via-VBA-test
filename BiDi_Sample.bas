...
' ========================================================================================
    ...
    With driver
        ...
        depXPath = "//input[@aria-label='Where from?']"
        
        ' Clear pre-populated value and type new city
        bidi.ExecuteInputValueByXPath depXPath, "Osaka"

        ' Click matching suggestion by text content
        Dim depSuggestXPath As String
        depSuggestXPath = "//ul[@role='listbox']//li[contains(., 'Osaka')]"
        ...
        destXPath = "//input[@aria-label='Where to? ']"
        ...
        destSuggestXPath = "//ul[@role='listbox']//li[contains(., 'Bangkok')]"
