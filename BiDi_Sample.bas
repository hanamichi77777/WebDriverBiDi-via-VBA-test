...
'    Dim blockList As Variant
'    blockList = Array( _
'        "*adobedtm*", "*demdex*", "*adobedc.net*", "*everesttech*", _
'        "*walkme*", "*qualtrics*", _
'        "*demandbase*", "*company-target*", "*ml314*", _
'        "*marketo*", "*munchkin*", "*mktoresp*", _
'        "*doubleclick*", "*googletagmanager*", "*google-analytics*", "*analytics.google*", "*pagead*", _
'        "*licdn*", "*ads.linkedin*", "*ads-twitter*", "*platform.twitter*", "*connect.facebook*", _
'        "*casalemedia*", "*adnxs*", "*adsrvr*", "*rlcdn*", "*everesttech*")
'    bidi.ExecuteEnableResourceBlocking blockList
