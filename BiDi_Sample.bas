...
Public Sub Main03()
  ...
  ' ==========================================
    ...
    ' Setting to block ads and trackers
    ' Images/fonts are blocked via browser capabilities, not here.
    Dim blockList As Variant
    blockList = Array( _
        "*ad_service*", "*google-analytics.com*", "*googletagmanager.com*", _
        "*doubleclick.net*", "*googlesyndication.com*", "*amazon-adsystem.com*", _
        "*criteo.com*", "*criteo.net*", "*adnxs.com*", "*teads.tv*", _
        "*popin.cc*", "*logly.co.jp*", "*microad.jp*", "*microad.net*", _
        "*fout.jp*", "*yads*", "*yjtag.yahoo.co.jp*", _
        "*facebook.net*", "*scorecardresearch.com*", _
        "*/collect*", "*/beacon*")
...
Public Sub Main07()
    ...
    bidi.ExecuteClickShadowBySelector "#utility-sign-in button"
...
' ========================================================================================
    ...
    With driver
        ...
        Dim blockList As Variant
        blockList = Array( _
            "*googletagmanager.com*", "*doubleclick.net*", _
            "*googlesyndication.com*", "*google-analytics.com*", _
        ...
        bidi.ExecuteClickByXPath depSuggestXPath
