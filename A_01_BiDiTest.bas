...
'  ' Example patterns to block common image formats and ad services
  ...
  ' Click search button
  bidi.ExecuteClickByXPath "//input[@id='searchModuleSubmit']", , True
...
Public Sub Main07()
  ...
  ' Click
  bidi.ExecuteShadowClick path, 10000, False

  ' Input
  bidi.ExecuteInputValueByXPath "//input[@id='username']", "aaa", 10000, True
