...
'  ' Example patterns to block common image formats and ad services
  ...
  ' Click search button
  bidi.ExecuteClickAndNavigateByXPath "//input[@id='searchModuleSubmit']"
...
Public Sub Main07()
  ...
  ' Click
  bidi.ExecuteShadowClickAndNavigate Path, True, 1000, 20000, , 15000
  ...
  ' Input
  bidi.ExecuteInputValueAndWaitByXPath "//input[@id='username']", "aaa"
